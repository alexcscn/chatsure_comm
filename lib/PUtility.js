...
const PUtility = {
    ...
    AuthMD5_Calc: function (pucName, pucRealm, pucPwd, pucMethod, pucAlg, pucNonce, pucUri) {
    ...
    GetBrowserName: function () {
        ...
        var userAgent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36';
    ...
    m_OrigLog: null,
    m_OrigLog: console.log
};

module.exports = PUtility;